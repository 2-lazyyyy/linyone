...
const translations = {
  ...
  my: {
    ...
    // Map
    'map.title': 'ငလျင်တုန်လှုပ်မှုအချက်ပေးမြေပုံ',
    ...
    'auth.trackingVolunteer': 'သတင်းပို့စေတနာ့ဝန်ထမ်း',
    'auth.supplyVolunteer': 'စေတနာ့ဝန်ထမ်း',
    ...
    'dashboard.emergencyKit': 'အရေးပေါ်အသုံးအဆောင်အိတ်',
    'dashboard.familyMembers': 'မိသားစုဝင်များ',
    'dashboard.safetyModules': 'လုံခြုံရေးသင်တန်းများ',
    ...
    'family.areYouOk': 'ဘေးကင်းပါသလား?',
    'family.markDone': 'ဘေးကင်းပါသည်ဟုမှတ်ယူရန်',
    'family.lastSeen': 'နောက်ဆုံးမြင်ရသော',
    'family.status': 'အခြေအနေ',
    
    // Safety Modules
    'safety.title': 'လုံခြုံရေးသင်တန်းများ',
